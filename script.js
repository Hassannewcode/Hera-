    ...
    t( () => {
        ...
        function() {
            let e = []
              ...
              , a = (null == r ? void 0 : r.dataset.endpoint) || (i ? `https://vitals.vercel-insights.com/v2/vitals?dsn=${i}&ve=production` : "/_vercel/speed-insights/vitals")
              , o = () => {
                var n, i;
                let o = ed()
                  , u = e.map(e => ({
                ...
                0 !== u.length && (em({
                    ...
                    metrics: u,
                    scriptVersion: "0.1.3",
                    sdkName: null != (n = null == r ? void 0 : r.getAttribute("data-sdkn")) ? n : void 0,
                    sdkVersion: null != (i = null == r ? void 0 : r.getAttribute("data-sdkv")) ? i : void 0
                }, a),
                e = [])
            }
              , u = () => {
            ...
            ( () => {
                ...
                if (window.sil)
                    return;
                window.sil = !0;
                let i = Number(null != (t = null == r ? void 0 : r.dataset.sampleRate) ? t : 1);
